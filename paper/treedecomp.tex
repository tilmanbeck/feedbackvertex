...
\item falls ein Bag zwei Kind-Knoten $l,r$ besitzt, dann gilt $B_x=B_l=B_r$
...
Ein Beispiel für eine standardmäßige Nice Tree Decomposition ist in Abbildung \ref{fig:ntd} gegeben.
