...
Unsere Ergebnisse in Sektion \ref{sec:impl_eval} eröffnen die Fragestellung inwiefern die Cut \& Count-Technik das Steinerbaumproblem hinsichtlich Laufzeit und Speicherbedarf effizient löst. 
...
Die Praxisrelevanz des Algorithmu für das Steinerbaumproblem wird auch durch die Art des Ergebnis verringert. Der Cut \& Count-Algorithmus liefert keine Lösung, sondern beantwortet nur die Frage ob eine solche existiert. Für Probleme, die eine Lösungsmenge benötigen, ist er somit nicht geeignet. Der Aufbau des dynamischen Programms lässt auch nicht ohne Weiteres Rückschlüsse auf die Lösungsmenge zu.
