...
Unsere Ergebnisse in Sektion \ref{sec:impl_eval} eröffnen die Fragestellung inwiefern die Cut &\ Count-Technik das Steinerbaumproblem effizient löst. Hier bedarf es weiterer Vergleiche mit anderen Ansätzen, wie z.~B. einer Brute-Force-Suche, welche für kleinere Graphen womöglich effizienter Lösungen berechnet.

In der Arbeit \cite{cygan_solving_2011} nicht auf den Speicherbedarf eingegangen. 
